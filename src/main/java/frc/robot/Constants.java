...
//  }
  public static final class ArmConstants{
    public static final double elevgearratio = 36 / 74;
    public static final double gripperratio = 36 / 110;
  }
  ...
  public static class ClimbConstants {
    ...
    public static final EncoderConfig CLIMB_ENCODER_CONFIG = new EncoderConfig();
